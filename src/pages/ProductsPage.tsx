...
export const ProductsPage = () => {
  ...
  const allProducts = [
    ...
    {
      id: 6,
      name: "Contemporary Kalamkari Art",
      price: 22999,
      originalPrice: 26999,
      rating: 4.7,
      reviews: 98,
  ...
  const categories = ['all', 'Kanjivaram', 'Kalamkari', 'Bandhani', 'Block Print'];
